class UserNotifier < ActionMailer::Base
  ...
  def send_create_notification_mail object
    setup_mail object, "DBTC: #{object.Project} cut created: "+truncate(object.title, length: 25)
  end

  def send_update_notification_mail object
    setup_mail object, "DBTC: #{object.Project} cut updated: "+truncate(object.title, length: 25)
  end

  def send_delete_notification_mail object
    setup_mail object, "DBTC: #{object.Project} cut deleted: "+truncate(object.title, length: 25)
  end
